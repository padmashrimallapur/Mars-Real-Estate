...
import com.example.android.marsrealestate.databinding.GridViewItemBinding as GridViewItemBinding1
...
class PhotoGridAdapter(val clickListener: OnClickListener)  : ListAdapter<MarsProperty, PhotoGridAdapter.MarsPropertyViewHolder>(DiffCallback){
    override fun onCreateViewHolder(
        ...
        return MarsPropertyViewHolder(GridViewItemBinding1.inflate(LayoutInflater.from(parent.context)))
    }
